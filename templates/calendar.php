...
?>
<div class="rc-rcc<?php echo esc_attr( $accent_class ); ?>" id="<?php echo esc_attr( $uid ); ?>" data-rc-rcc data-rc-rcc-version="<?php echo esc_attr( RC_RCC_VERSION ); ?>"<?php echo ( '' !== $accent_style ) ? ' style="' . esc_attr( $accent_style ) . '"' : ''; ?>>
